...
# Based on: https://raw.githubusercontent.com/mame82/duck2spark
...
Usage: python3 duck2spark.py -i [file ..]            build Sketch from specified RubberDucky payload file
   or: python3 duck2spark.py -i [file ..] -o [file ..]    save Sketch source to specified output file
    ...
    for opt, arg in opts:
        if opt in ("-h", "--help"):
            ...
            if not os.path.isfile(ifile) or not os.access(ifile, os.R_OK):
                print(f"Input file {ifile} doesn't exist or isn't readable")
                sys.exit(2)
